...
const colorVariants: Record<ColorVariant, string> = {
  ...
  charcoalOutline: 'border border-gray-900 text-gray-900 hover:bg-gray-900 hover:text-white',
  slateOutline: 'border border-gray-800 text-gray-800 hover:bg-gray-800 hover:text-white',
  darkGrayOutline: 'border border-gray-700 text-gray-700 hover:bg-gray-700 hover:text-white',
  grayOutline: 'border border-gray-600 text-gray-600 hover:bg-gray-600 hover:text-white',
  mediumGrayOutline: 'border border-gray-500 text-gray-500 hover:bg-gray-500 hover:text-white',
  lightGrayOutline: 'border border-gray-400 text-gray-400 hover:bg-gray-400 hover:text-white',
  lightWhiteOutline: 'border border-gray-100 text-gray-100 hover:bg-gray-200 hover:text-black',
  red: 'bg-red-600 hover:bg-red-700 text-white',
  redOutline: 'border border-red-600 text-red-600 hover:bg-red-600 hover:text-white',
  brandRed: 'bg-[#Ed3237] hover:bg-[#A80006] text-white',
  brandRedOutline: 'border border-[#Ed3237] text-[#Ed3237] hover:bg-[#Ed3237] hover:text-white',
