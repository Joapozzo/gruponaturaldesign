                                    ...
                                    >
                                        ...
                                        {itemCount > 0 && (
                                            <motion.span
                                                initial={{ scale: 0 }}
                                                animate={{ scale: 1 }}
                                                className="absolute -top-2 -right-2 sm:-top-2 sm:-right-2 bg-[#Ed3237] text-white text-[10px] sm:text-xs rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center font-semibold"
                                            >
                                                {itemCount}
                                            </motion.span>
                                        )}
                                                            ...
                                                            <div className="pl-4 sm:pl-5 pr-3 py-2.5 sm:py-3 bg-gray-50 rounded-lg mt-1.5">
                                                                ...
                                                                {categories?.generos && categories.generos.length > 0 && (
                                                                    <div className="mb-4 sm:mb-5">
                                                                        <h3 className="text-[11px] sm:text-[12px] font-bold text-gray-500 uppercase tracking-wider mb-2 sm:mb-2">GÉNERO</h3>
                                                                ...
                                                                {/* Rubros */}
                                                                {categories?.rubros && categories.rubros.length > 0 && (
                                                                    <div className="mb-3 sm:mb-4 border-t border-gray-200 pt-3 sm:pt-3.5">
                                                                        <h3 className="text-[11px] sm:text-[12px] font-bold text-gray-500 uppercase tracking-wider mb-2 sm:mb-2">RUBROS</h3>
                                                                        <div className="overflow-x-auto -mx-2 px-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                                                            <div className="flex gap-2 sm:gap-2.5 pb-2" style={{ WebkitOverflowScrolling: 'touch' }}>
                                                                                {categories.rubros.map((rubro) => (
                                                                                    <button
                                                                ...
                                                                {categories?.subrubros && categories.subrubros.length > 0 && (
                                                                    <div className="mb-3 sm:mb-4 border-t border-gray-200 pt-3 sm:pt-3.5">
                                                                        <h3 className="text-[11px] sm:text-[12px] font-bold text-gray-500 uppercase tracking-wider mb-2 sm:mb-2">CATEGORÍAS</h3>
                                                                        <div className="overflow-x-auto -mx-2 px-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                                                                            <div className="flex gap-2 sm:gap-2.5 pb-2" style={{ WebkitOverflowScrolling: 'touch' }}>
                                                                                {categories.subrubros.map((subrubro) => (
                                                                                    <button
